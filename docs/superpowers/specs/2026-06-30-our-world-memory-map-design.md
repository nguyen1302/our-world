...
- **Node = một Memory.** Click marker → **Memory Card** hiện **gallery ảnh ngay tại node đó** (cover, lưới ảnh, ngày, địa điểm, ghi chú). Click ảnh → xem lớn / lướt gallery. Đây là cách "xem được ảnh ở từng node".
